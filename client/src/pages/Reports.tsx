...
import { MapPin, Calendar, AlertTriangle, Waves, Home, List, ChevronLeft } from "lucide-react";
      ...
      <div className="container mx-auto p-6">
        <div className="flex flex-col mb-6">
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <Link href="/" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md transition-colors flex items-center">
        ...
        {reports && reports.length === 0 ? (
          <div className="text-center p-12 border border-dashed rounded-lg">
            ...
            <Link href="/">
              <button className="btn bg-blue-500 text-white px-4 py-2 rounded flex items-center mx-auto">
                <Home size={18} className="mr-2" />
                Report Pollution
              </button>
            </Link>
